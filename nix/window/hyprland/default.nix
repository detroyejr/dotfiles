...
in
{
  ...
  #       repeat_delay = 300
  #       touchpad {
  #           natural_scroll = ${if osConfig.services.libinput.touchpad.naturalScrolling then "0" else "1"}
  #           scroll_factor = ${osConfig.services.libinput.touchpad.accelSpeed}
  #           drag_lock = ${if osConfig.services.libinput.touchpad.tappingDragLock then "1" else "0"}
  #       }
  #   }
  #
  #   general {

      ...
      settings = {
        dns = {
          ...
          hosts = [
            ...
            "192.168.1.14 odp-4"
            "192.168.1.251 odp-5"
            "192.168.1.222 cache.odp-1"
            "192.168.1.32 cache.odp-2"
            "192.168.1.229 cache.odp-3"
            "192.168.1.14 cache.odp-4"
            "192.168.1.222 grafana.odp-1"

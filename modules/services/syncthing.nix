...
let
  ...
  devices = {
    ...
    vulture = {
      id = "CLH2ZL4-D67QFF7-3WLEER3-B7PG2RY-CGB2T25-5GKKGCK-PHGOHQY-ZRJYFAJ";
    };
    warthog = {
      id = "NVMRUVY-2ZXWCR2-CGV5SG3-REEYWY5-JLKSN7S-LNL7EUA-JQGILLK-B3V4UQY";
    };
  };
in
{
  config = lib.mkIf cfg.enable {
    ...
    system.activationScripts.syncthingPermissions = {
      text = ''
        ...
        mkdir -p /home/${config.defaultUser}/Documents

...
in
{
  config = lib.mkIf cfg.enable {
    programs.neovim = {
      ...
      runtime = {
        "lsp/air.lua".source = ../../dotfiles/nvim/lsp/air.lua;
        "lsp/ark.lua".source = ../../dotfiles/nvim/lsp/ark.lua;
        "lsp/clangd.lua".source = ../../dotfiles/nvim/lsp/clangd.lua;
        "lsp/jarl.lua".source = ../../dotfiles/nvim/lsp/jarl.lua;
        "lsp/lua_ls.lua".source = ../../dotfiles/nvim/lsp/lua_ls.lua;
        "lsp/nixd.lua".source = ../../dotfiles/nvim/lsp/nixd.lua;
        "lsp/pylsp.lua".source = ../../dotfiles/nvim/lsp/pylsp.lua;
        "lsp/ruff.lua".source = ../../dotfiles/nvim/lsp/ruff.lua;
        "lsp/rust_analyzer.lua".source = ../../dotfiles/nvim/lsp/rust_analyzer.lua;
        "lsp/snippets_lsp.lua".source = ../../dotfiles/nvim/lsp/snippets_lsp.lua;
        "lsp/_snippets_lsp.py".source = ../../dotfiles/nvim/lsp/_snippets_lsp.py;
        "snippets".source = ../../dotfiles/nvim/snippets;
      };
    };
